 ...
 */
@Autonomous (name = "JoshBSEauto", group = "robot")
public class JoshBSEauto extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //sleep(100);
            encoderDrive(TURN_SPEED/2, 10, -10, 10.0);
            //sleep(100);
            encoderDrive(DRIVE_SPEED/2, 100, 100, 3.0);

            encoderDrive(TURN_SPEED/2, -15, 15, 4.0);
            //sleep(100);
